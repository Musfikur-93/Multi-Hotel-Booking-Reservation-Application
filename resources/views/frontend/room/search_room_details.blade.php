                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input autocomplete="off" type="text" class="form-control dt_picker" name="check_in" id="check_in" placeholder="yyy-mm-dd" required value="{{ old('check_in') ? date('Y-m-d', strtotime(old('check_in'))) : '' }}">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input autocomplete="off" type="text" class="form-control dt_picker" name="check_out" id="check_out" placeholder="yyy-mm-dd" required value="{{ old('check_out') ? date('Y-m-d', strtotime(old('check_out'))) : '' }}">
                                <span class="input-group-addon"></span>
                            </div>
                            <i class='bx bxs-calendar'></i>
                        </div>
