            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item">
                    <a href="{{ url('blog/details/'.$item->post_slug) }}">
                        <img src="{{ asset($item->post_image) }}" alt="Images" style="width: 550px; height: 370px;">
                    </a>
                    <div class="content">
                        <ul>
                        ...
                        <h3>
                            <a href="{{ url('blog/details/'.$item->post_slug) }}">{{ substr($item->post_title,0,30) }}</a>
                        </h3>
                        <p>{{ substr($item->short_desc, 0, 100) }}</p>
