                    ...
                    <div class="contact-item">
                        <ul>
                            <li>
                                ...
                                <div class="content">
                                    <span class="pb-3">{{ $setting->address }}</span>
                            ...
                            <li>
                                ...
                                <div class="content">
                                    <span class="pb-3"><a href="tel:{{ $setting->phone }}">{{ $setting->phone }}</a></span>
                            ...
                            <li>
                                ...
                                <div class="content">
                                    <span class="pb-3"><a href="mailto:{{ $setting->email }}">{{ $setting->email }}</a></span>
