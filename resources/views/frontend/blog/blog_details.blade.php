                ...
                <div class="blog-article">
                    ...
                    <div class="comments-wrap">
                        ...
                        <ul>
                            ...
                            <li>
                                <img src="{{ (!empty($com->user->photo)) ? url('upload/user_images/'.$com->user->photo) : url('upload/no_image.jpg') }}" style="width: 50px; height: 50px;" alt="Image">
                                <h3>{{ $com->user->name }}</h3>
                    ...
                    <div class="comments-form">
                        <div class="contact-form">
                            ...
                            @else
                                <p>Please <a href="{{ route('login') }}">Login</a> First for Add Comments</p>
                            @endauth
                        </div>
                    </div>
                </div>
