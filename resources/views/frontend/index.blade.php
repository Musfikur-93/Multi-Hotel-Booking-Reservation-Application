                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input autocomplete="off" type="text" class="form-control dt_picker" name="check_in" placeholder="yyy-mm-dd" required>
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input autocomplete="off" type="text" class="form-control dt_picker" name="check_out" placeholder="yyy-mm-dd" required>
                                <span class="input-group-addon"></span>
                            </div>
                            <i class='bx bxs-chevron-down'></i>
                        </div>
