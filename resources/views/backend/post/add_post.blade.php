		...
		<div class="col-lg-10">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('store.blog.post') }}" method="post" class="row g-3" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" name="short_desc" id="input11" placeholder="Address ..." rows="3"></textarea>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <img id="showImage" src="{{ url('upload/no_image.jpg') }}" alt="Post" class="rounded-circle p-1 bg-primary" width="80">
                        </div>
