			...
			<div class="card">
				...
				<div class="card-body">
                    ...
                    <div class="row mb-3">
						...
						<div class="form-group col-sm-9 text-secondary">
							<textarea class="form-control" id="input40" name="short_desc" rows="3">{!! $book->short_desc !!}</textarea>
						</div>
					</div>
                    <div class="row mb-3">
						<div class="col-sm-3">
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9 text-secondary">
							<img id="showImage" src="{{ asset($book->image) }}" alt="Book Area" class="rounded-circle p-1 bg-primary" width="80">
						</div>
					</div>
					<div class="row">
