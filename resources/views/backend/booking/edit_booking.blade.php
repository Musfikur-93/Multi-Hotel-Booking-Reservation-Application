                ...
                <div class="table-responsive table-strip">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="badge bg-success">{{ $assign_room->room_number->status }}</td>
                            <td>
                                <a href="{{ route('assign_room_delete',$assign_room->id) }}" class="badge bg-primary" id="delete"><i class="lni lni-cross-circle"></i> Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </table>
            ...
            <div class="card radius-10 w-100">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">Zip Code <span class="badge bg-warning text-dark rounded-pill">{{ $editData->zip_code }}</span>
                        </li>
                    </ul>
