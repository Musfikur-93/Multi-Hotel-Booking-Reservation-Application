		...
		<div class="col-lg-10">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('store.gallery') }}" method="post" class="row g-3" enctype="multipart/form-data">
                        @csrf


                        <div class="col-md-12">
                            <label for="input1" class="form-label">Gallery Image </label>
                            <input type="file" name="photo_name[]" class="form-control" id="multiImg" multiple><br>
