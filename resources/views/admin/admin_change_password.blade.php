			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9 text-secondary" id="show_hide_password">
							<input type="password" name="new_password" class="form-control border-end-0 @error('new_password') is-invalid @enderror" id="new_password"/>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9 text-secondary" id="show_hide_password">
							<input type="password" name="new_password_confirmation" class="form-control" id="new_password_confirmation"/><a href="javascript:;" class="input-group bg-transparent"><i class="bx bx-hide"></i></a>
						</div>
					</div>
